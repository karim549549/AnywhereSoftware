...
__decorate([
    (0, swagger_1.ApiProperty)({ description: 'Title of the announcement', minLength: 3, maxLength: 100 }),
...
__decorate([
    (0, swagger_1.ApiProperty)({ description: 'Content of the announcement', minLength: 10, maxLength: 1000 }),
    (0, class_validator_1.IsNotEmpty)(),
    (0, class_validator_1.IsString)(),
